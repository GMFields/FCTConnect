...
public class StaticMediaResource extends HttpServlet implements StaticMediaAPI {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		// Download file from a specified bucket. The request must have the form
		// /gcs/<bucket>/<object>
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		// Upload file to specified bucket. The request must have the form
		// /gcs/<bucket>/<object>
		Path objectPath = Paths.get(req.getPathInfo());
		...
		// Changed version from another upload function given by cloud storage API
		// @GMFields
