...
Future<void> _initializeApi() async {
 ...
 void _saveImageToBucket() async {
  ...
  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Profile(email: _controllers.emailController.text,)));
  ...
  SharedPreferences prefs = await SharedPreferences.getInstance();
  await prefs.setStringList('imageBytes', imageBytes.map((byte) => byte.toString()).toList());
}
